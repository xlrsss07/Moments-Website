 ...
 */
    ...
    //$db_hostname='49.51.137.126'; //数据库IP，这个是本地测试地址，如果移植到网站服务器，一般为localhost
    $db_hostname="udm708730221.my3w.com";
    $db_database = "udm708730221_db";    //数据库的对应数据库
    $db_username = "udm708730221";    //数据库用户名
    $db_password = "Moments666";    //数据库密码
